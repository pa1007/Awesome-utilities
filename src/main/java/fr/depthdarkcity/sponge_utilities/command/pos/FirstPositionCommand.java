...
public class FirstPositionCommand extends AbstractCommand {

    public FirstPositionCommand(SpongeUtilities spongeUtilities) {
    ...
    public CommandSpec createCommand() {
        return CommandSpec.builder().arguments(GenericArguments.optional(GenericArguments.vector3d(Text.of("Pos"))))
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (optionalPos.isPresent()) {
            pos = optionalPos.get();
            pluginInstance.getFirstPos().put(player.getUniqueId(), pos);
        }
        else if (pluginInstance.getFirstPos().containsKey(player.getUniqueId())) {
            ...
            Text second =
                    Text.builder().color(TextColors.BLUE).append(Text.of(" - You want to OverWrite the second pos !")).onClick(
        ...
        player.sendMessage(Text.of(TextColors.GREEN,
                                   "The position has been set at the coordinate : " + pluginInstance.getFirstPos().get(
