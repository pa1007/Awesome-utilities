...
public class TempBanForXRayCommand extends AbstractCommand {

    public TempBanForXRayCommand(SpongeUtilities spongeUtilities) {
        super(spongeUtilities);
    }

    @Override
    public String[] getNames() {
        return new String[]{"TempBanForXRay"};
    }
    ...
    public CommandResult execute(CommandSource src, CommandContext args) {
        ...
        try {
            ...
            if (service.hasBan(ban)){
                ...
                user.kick(Text.of("You have been banned for usage of X-Ray for",expiration ," , plz go to the web site "));
