...
public class BanForHacksCommand extends AbstractCommand {
    private Game                                                   game            = Sponge.getGame();
    private org.spongepowered.api.item.inventory.Inventory.Builder builder         = Inventory.builder();

    public BanForHacksCommand(SpongeUtilities spongeUtilities) {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) {
        ...
        try {
            ...
            if (service.hasBan(ban)){
               ...
               user.kick(Text.of("You have been banned for usage of hacks, plz go to the web site"));
